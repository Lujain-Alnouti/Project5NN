...
<body>
  ...
  <div class="card-body">
    <h5 class="card-title" style="margin-left:10%; font-size:50px ; font-weight:bold">
        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></h5>
   <%-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
 --%> <%--<button runat="server" >Delete</button>--%>
    
      <asp:Button ID="Button1" runat="server" Text="Delete" style="width:100px ;margin-left:280px ;background-color:#2B3467; color:#D9D6D6;padding:8px" OnClick="Button1_Click1" />
      <br />
