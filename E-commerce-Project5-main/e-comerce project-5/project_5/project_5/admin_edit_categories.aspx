            ...
            <div class="appear" id="appear">
                ...
                <div class=" edit">
                    ...
                    <div class="upload_image">
                        ...
                        <asp:Button ID="btnUpload" Text="Category Image" runat="server" OnClick="btnUpload_Click"  />  <asp:Label ID="Label3" runat="server" Text="Category is edit successfully" style="color:green" Visible="false"></asp:Label>
<hr /> 
